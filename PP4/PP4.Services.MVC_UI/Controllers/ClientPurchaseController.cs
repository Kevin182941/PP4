using PP4.DAL;
using PP4.Services.MVC_UI.Models.ViewModels.ViewModelClientPurchase;
using System;
...
namespace PP4.Services.MVC_UI.Controllers
{
    public class ClientPurchaseController : Controller
    {
        // GET: ClientPurchase
